...
class HoldingsHandler:
    ...
    async def handle(self, user_id: str) -> AppResponse:
        try:
            ...
            logger.exception("Unexpected error in HoldingsHandler")
...
class WinnersHandler:
    ...
    async def handle(self, user_id: str) -> AppResponse:
        try:
            ...
            logger.exception("Unexpected error in WinnersHandler")
            return AppResponse(type=ResponseType.TEXT, text=UNEXPECTED_ERROR)
...
class LosersHandler:
    ...
    async def handle(self, user_id: str) -> AppResponse:
        try:
            ...
            logger.exception("Unexpected error in LosersHandler")
            return AppResponse(type=ResponseType.TEXT, text=UNEXPECTED_ERROR)
